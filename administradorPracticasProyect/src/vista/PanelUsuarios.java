...
public class PanelUsuarios extends javax.swing.JPanel {
    ...
    List<Usuario> usuarios = usuariosMetodos.rellenarListaUsuarios("select * from usuarios where eliminado = FALSE ORDER BY id ASC");

    public PanelUsuarios() {
        initComponents();
        tablaUsuarios = usuariosMetodos.prepararRenderizadoCeldas(tablaUsuarios);
        tablaUsuarios = usuariosMetodos.prepararEditadoCeldas(tablaUsuarios);

        tablaUsuarios.setRowHeight(49);
        tablaUsuarios.getColumnModel().getColumn(6).setMinWidth(113);
        tablaUsuarios.getColumnModel().getColumn(6).setMaxWidth(113);
        tablaUsuarios = usuariosMetodos.rellenarTablaAlumnos(tablaUsuarios, usuarios);
    }
    ...
    private void initComponents() {
        ...
        tablaUsuarios.setFont(new java.awt.Font("Roboto", 0, 11)); // NOI18N
        tablaUsuarios.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[] {
                        "Id", "Nombre", "Apellidos", "Telefono", "Email", "Fecha de nacimiento", "Password",
                        "Tipo de usuario"
                }) {
        ...
        tablaUsuarios.setSelectionBackground(new java.awt.Color(254, 177, 3));
                ...
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                .addComponent(tfBusqueda, javax.swing.GroupLayout.DEFAULT_SIZE, 228,
                                                        Short.MAX_VALUE)
                                                .addContainerGap())
        ...
        jPanel1Layout.setVerticalGroup(
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(tfBusqueda, javax.swing.GroupLayout.PREFERRED_SIZE, 25,
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 1038,
                                                Short.MAX_VALUE)
                                        .addGroup(layout.createSequentialGroup()
    ...
    private void jPanel2MouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jPanel2MouseClicked
        ...
        if (!tfBusqueda.getText().equals("Busque en cualquier campo")) {
                usuarios = usuariosMetodos.rellenarListaUsuarios(
                        "SELECT * FROM usuarios WHERE CAST(id AS TEXT) LIKE '%" + tfBusqueda.getText()
                                + "%' "
