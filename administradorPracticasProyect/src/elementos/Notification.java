...
public class Notification extends javax.swing.JComponent {
    ...
    private void init(String message) {
        ...
        if (type == Type.SUCCESS) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/elementos/sucess.png")));
            lbMessage.setText("Exito");
        } else if (type == Type.INFO) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/elementos/info.png")));
            lbMessage.setText("Info");
        } else {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/elementos/warning.png")));
            lbMessage.setText("Aviso");
        }
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/elementos/sucess.png"))); // NOI18N

        panel.setOpaque(false);

        lbMessage.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        ...
        cmdClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/elementos/close.png"))); // NOI18N
