package elementos.mensaje.message;

import java.awt.Color;
import java.awt.event.WindowAdapter;
import java.awt.event.WindowEvent;
import elementos.mensaje.swing.Glass;
...
public class MessageDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        background1 = new elementos.mensaje.message.Background();
        cmdCancel = new elementos.mensaje.swing.ButtonCustom();
        cmdOK = new elementos.mensaje.swing.ButtonCustom();
        ...
        cmdCancel.setBackground(new java.awt.Color(254, 177, 3));
        cmdCancel.setText("Cancel");
        cmdCancel.setColorHover(botonSeleccionado);
        cmdCancel.setColorPressed(new java.awt.Color(235, 61, 61));
        cmdCancel.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        ...
        cmdOK.setBackground(new java.awt.Color(254, 177, 3));
        cmdOK.setText("OK");
        cmdOK.setColorHover(botonSeleccionado);
        cmdOK.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/elementos/mensaje/message/icon.png"))); // NOI18N

        lbTitle.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        lbTitle.setForeground(new java.awt.Color(254, 177, 3));
        lbTitle.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbTitle.setText("Message Title");

        txt.setEditable(false);
        txt.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        ...
        background1Layout.setVerticalGroup(
                background1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, background1Layout.createSequentialGroup()
                                ...
                                .addComponent(txt, javax.swing.GroupLayout.PREFERRED_SIZE, 60,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
    ...
    private elementos.mensaje.message.Background background1;
    private elementos.mensaje.swing.ButtonCustom cmdCancel;
    private elementos.mensaje.swing.ButtonCustom cmdOK;
